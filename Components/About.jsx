...
function About() {
  return (
    <motion.div id='About' className='w-full px-[12%] py-10 scroll-mt-75 mb-18 '
      initial={{ opacity: 0 }}
    ...
    >
      <motion.h4
        ...
        className='text-center  text-lg font-Ovo mt-30  ml-20' >
        Introduction
      </motion.h4>
      <motion.h2
        initial={{ opacity: 0, y: -20 }}
        ...
        className='text-center text-5xl font-Ovo mt-5 ml-20'>
        About me
      </motion.h2>
      <motion.div
        initial={{ opacity: 0 }}
        ...
        <motion.div
          ...
          className='w-64 sm:w-80 rounded-3xl max-w-none mb-11'>
