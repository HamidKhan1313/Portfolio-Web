...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "c577aeb2-bef4-4062-941e-f7c63a714cfd");
  ...
  return (
    ...
    footer-bg-color.png")] bg-no-repeat bg-center bg-[length:90%_auto dark:bg-none]'>
       <h4 className='text-center  text-lg font-Ovo' >
              Connect with me 
            </h4>
            ...
            I'd love to hear from you! If you have any questions, comments, or feedback, plese use the form below.
            </p>
            <form onSubmit={onSubmit} className='max-w-2xl mx-auto'>
                <div className='grid grid-col-auto gap-6 mt-10 mb-8'>

                    <input type="text" placeholder='Enter your name' required 
                    className='flex-1 p-3outline-none border-[0.5px] border-gray-400 
               ...
               text-white rounded-full max-auto hover:bg-black duration-500 dark:bg-transparent
               dark-border-[o.5px] dark:hover:bg-darkHover'
